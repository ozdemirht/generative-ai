...
- Next, I asked for a **learning path**, training via **quiz** and **simulation**.
  ...
  For instance, when CHW takes a quiz, HeartGuard evaluates the answer and presents the correct answer so that CHW can train to recall what is in the guidelines. 
